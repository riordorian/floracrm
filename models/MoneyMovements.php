 ...
 */
class MoneyMovements extends \yii\db\ActiveRecord
{
            ...
            if( $this->isNewRecord === false ){
                ...
                try{
                    if( $oldAccount == $arAttrs['MONEY_ACCOUNT'] ){
                        $obMoneyAccount->makeTransaction($newAmount, $arAttrs['CASHBOX_ID']);
                    }
                    else{
                        $obOldMoneyAccount = MoneyAccounts::findOne($oldAccount, $arAttrs['CASHBOX_ID']);
                        $obOldMoneyAccount->makeTransaction(-$oldAmount, $arAttrs['CASHBOX_ID']);
                        $obMoneyAccount->makeTransaction($newAmount, $arAttrs['CASHBOX_ID']);
                    }
